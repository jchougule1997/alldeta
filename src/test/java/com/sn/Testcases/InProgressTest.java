...
public class InProgressTest extends TestBase
{
	...
	@BeforeMethod
	public void setup(String Caller, String Shortdescription, CharSequence FilterNavigator) throws InterruptedException, IOException 
	{
		launch();
